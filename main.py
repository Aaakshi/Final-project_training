...
@app.post("/api/bulk-upload", response_model=BulkAnalysis: This code modifies the bulk upload functionality to allow users to select a department during upload and routes notifications based on the selected department.