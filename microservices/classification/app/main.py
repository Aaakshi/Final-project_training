    ...
    classification_rules = [
        ...
        },
        {
            "keywords": ["finance", "financial planning", "budgeting", "accounting", "financial reporting", 
                        ...
                        "capital expenditure", "erp", "enterprise resource planning", 
                        ...
                        "financial", "fiscal", "budget", "expenditures", "roi", "return on investment",
                        "cost center", "profit margin", "gross margin", "net income", "ebitda",
                        "depreciation", "amortization", "asset", "liability", "equity", "shareholder",
                        "dividend", "stock option", "investment", "portfolio", "fund", "capital",
                        "financing", "loan", "mortgage", "interest", "apr", "credit rating",
                        "cash advance", "petty cash", "wire transfer", "ach", "check", "money order",
                        "procurement", "sourcing", "vendor", "supplier", "contract", "rfp", "rfq",
                        "quarterly report", "annual report", "10k", "10q", "earnings", "sec filing",
                        "tax return", "1099", "w2", "w4", "payroll tax", "sales tax", "vat"],
            "filename_keywords": ["finance", "financial", "budget", "accounting", "invoice", "bill", "receipt", 
                                 ...
                                 "p&l", "balance", "cash", "flow", "roi", "margin", "earnings", "filing"],
